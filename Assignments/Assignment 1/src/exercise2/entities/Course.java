...
import exercise2.util.TableGenerator;
...
public class Course {
    ...
    // The teaching assistant assigned to the course
    ...
    /**
     * Gets the teaching assistant teaching the course.
     *
     * @return the teaching assistant
     */
    ...
    /**
     * Sets the teaching assistant teaching the course.
     *
     * @param ta the teaching assistant to set
     */
    public void setTeachingAssistant(TeachingAssistant ta) {
        this.ta = ta;
    }
    ...
    /**
     * Gets the name of the teaching assistant teaching the course.
     *
     * @return the teaching assistant's full name or "Not yet assigned" if no teaching assistant is set
     */
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\tCourse teaching assistant: " + getTeachingAssistantName() + "\n"
